...
<head>
   ...
   <!-- Добавили событие wp_head, которое вызовет функцию wp_enqueue_scripts, описанное в 
   файле scripts.phph 
-->
...
<!-- echo выводит на страницу текстовую информацию. В данном случае выводи результат
функции get_template_directory_uri - вывод путь к стилям -->
